...
urlpatterns = [
    ...
    path("pos/table/<int:table_id>/pay/", views.mark_table_paid, name="mark_table_paid"),
    ...
    path("mesa/<int:table_id>/pagar/", views.mark_table_paid, name="mark_table_paid_alt"),
    ...
    path("reportes/comandas/csv/", views.export_orders_csv, name="export_orders_csv_alt"),
    # ==========================
    ...
    path("menu/products/<int:product_id>/edit/", views.product_edit, name="product_edit"),
    path("menu/products/<int:product_id>/delete/", views.product_delete, name="product_delete"),
    path("menu/products/<int:product_id>/recipes/", views.product_recipes, name="product_recipes"),
    ...
    path("menu/categories/<int:category_id>/edit/", views.category_edit, name="category_edit"),
    path("menu/categories/<int:category_id>/delete/", views.category_delete, name="category_delete"),
    path("menu/dispatch-areas/", views.dispatch_area_list, name="dispatch_area_list"),
    path("menu/dispatch-areas/new/", views.dispatch_area_create, name="dispatch_area_create"),
    path("menu/dispatch-areas/<int:area_id>/edit/", views.dispatch_area_edit, name="dispatch_area_edit"),
    path("menu/dispatch-areas/<int:area_id>/delete/", views.dispatch_area_delete, name="dispatch_area_delete"),
    # Alias español
    path("productos/", views.product_list, name="product_list_alt"),
    path("productos/nuevo/", views.product_create, name="product_create_alt"),
    path("productos/<int:product_id>/editar/", views.product_edit, name="product_edit_alt"),
    path("productos/<int:product_id>/eliminar/", views.product_delete, name="product_delete_alt"),
    path("productos/<int:product_id>/recetas/", views.product_recipes, name="product_recipes_alt"),
    ...
    path("categorias/<int:category_id>/editar/", views.category_edit, name="category_edit_alt"),
    path("categorias/<int:category_id>/eliminar/", views.category_delete, name="category_delete_alt"),
    path("areas-despacho/", views.dispatch_area_list, name="dispatch_area_list_alt"),
    path("areas-despacho/nueva/", views.dispatch_area_create, name="dispatch_area_create_alt"),
    path("areas-despacho/<int:area_id>/editar/", views.dispatch_area_edit, name="dispatch_area_edit_alt"),
    path("areas-despacho/<int:area_id>/eliminar/", views.dispatch_area_delete, name="dispatch_area_delete_alt"),
    # ==========================
    # Inventory - Ingredientes y Movimientos
    # ==========================
    path("inventory/ingredients/", views.ingredient_list, name="ingredient_list"),
    path("inventory/ingredients/new/", views.ingredient_create, name="ingredient_create"),
    path("inventory/ingredients/<int:ingredient_id>/edit/", views.ingredient_edit, name="ingredient_edit"),
    path("inventory/ingredients/<int:ingredient_id>/delete/", views.ingredient_delete, name="ingredient_delete"),
    path("inventory/adjust/", views.inventory_movement, name="inventory_movement"),
    path("inventory/purchase/", views.purchase_ingredients, name="purchase_ingredients"),
    # Alias español
    ...
    path("ingredientes/<int:ingredient_id>/editar/", views.ingredient_edit, name="ingredient_edit_alt"),
    path("ingredientes/<int:ingredient_id>/eliminar/", views.ingredient_delete, name="ingredient_delete_alt"),
    path("ingredientes/movimientos/", views.inventory_movement, name="inventory_movement_alt"),
    path("ingredientes/compras/", views.purchase_ingredients, name="purchase_ingredients_alt"),
    # ==========================
    # Reports - Reportes
    # ==========================
    ...
    path("reports/sales-by-product/", views.sales_report_by_product, name="sales_report_by_product"),
    path("reports/sales-by-product/csv/", views.export_sales_by_product_csv, name="export_sales_by_product_csv"),
    # Alias español
    path("reportes/saldo-ingredientes/", views.report_inventory, name="report_inventory_alt"),
    path("reportes/saldo-ingredientes/imprimir/", views.print_inventory_report, name="print_inventory_report_alt"),
    path("reportes/saldo-ingredientes/csv/", views.export_inventory_csv, name="export_inventory_csv_alt"),
    path("reportes/movimiento-ingredientes/", views.report_movements, name="report_movements_alt"),
    path("reportes/movimiento-ingredientes/csv/", views.export_movements_csv, name="export_movements_csv_alt"),
    path("reportes/ventas-producto/", views.sales_report_by_product, name="sales_report_by_product_alt"),
    path("reportes/ventas-producto/csv/", views.export_sales_by_product_csv, name="export_sales_by_product_csv_alt"),
    # ==========================
